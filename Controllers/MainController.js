...
app.controller('CheckInController', function($scope, $http) {
	   $scope.checkMeIn = function(location) {
		   var x = document.getElementById("checkIn_info").innerHTML;
		   console.log(x);
...
app.controller('DisplayUserCheckIns', function($scope, $http) {
	   
		   
		   console.log('0000000000000000000000000000   Display CheckIns 000000000000000000000000');
		   $http.get("http://localhost:3000/getCheckInInfo")
		   .success(function (data) {
